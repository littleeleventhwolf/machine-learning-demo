...
class BrainDQN:
	def __init__(self, actions):
		...
		self.copyTargetQNetworkOperation = [self.W_conv1T.assign(self.W_conv1),
			...
			self.b_conv3T.assign(self.b_conv3), self.W_fc1T.assign(self.W_fc1),
			self.b_fc1T.assign(self.b_fc1), self.W_fc2T.assign(self.W_fc2),
			self.b_fc2T.assign(self.b_fc2)]

		self.createTrainingMethod()

		# saving and loading networks
		self.saver = self.train.Saver()
	...
	def setPerception(self, nextObservation, action, reward, terminal):
		...
		self.replayMemory.append((self.currentState, action, reward, 
								  newState, terminal))
	...
	def setInitState(self, observation):
		self.currentState = np.stack((observation, obsevation,
